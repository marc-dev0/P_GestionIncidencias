...
public class BE_Incidencia {
	int codigoincidencia, codigoUsuario, codigoEspecialista,
			codigoTipoIncidencia, tiempoEstimado, estado;
	long tiempoReal;
	 ...
	 */
	public BE_Incidencia(int codigoIncidencia, int codigoUsuario,
			int codigoEspecialista, int codigoTipoIncidencia,
			String descripcion, String observacion, int tiempoEstimado,
			long tiempoReal, Date fechaRegistro, Date fechaInicio,
