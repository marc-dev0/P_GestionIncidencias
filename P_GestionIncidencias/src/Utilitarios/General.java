...
public class General {
	 ...
	 * 
	 * @param tabbedPane
	 *            Ingrese el TabbedPane que desea cambiar su estado
	 * @param estado
	 *            Ingrese True si el indice que desea que aparezca sera el 1.
	 *            False si el indice que desea que aparezca sera el 0
	 */
	...
	public static boolean isNumeric(String matcher) {

		Pattern patron = Pattern.compile("^[\\d]*$");
		Matcher mat = patron.matcher(matcher);
	...
	public static boolean isNullOrEmpty(String[] datos){
		int i = 0;
		for(String s : datos){
			if(s.isEmpty());
		}
